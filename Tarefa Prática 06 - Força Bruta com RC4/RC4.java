...
public class RC4 {
	...
	public String streamGeneration (int [] S, String entrada) {
		int i = 0, j = 0, l = 0, k, t;
		String msgCifrada = "";
		byte entradaByte [] = entrada.getBytes();		
		...
		msgCifrada = new String(saidaByte);
	...
	public String cifrar(String entrada, int K []){
		int S [] = s();
		int T [] = t(K);
