...
public class Tela extends javax.swing.JFrame {
        ...
        */
        ...
        if (!txtMensagem.getText().equals("Sair")) {
            ...
            if (((String) combEncriptador.getSelectedItem()).compareTo("SDES") == 0) {
                ...
                try {
                    cipherText = new String(cifradorRC4.cifrar(txtMensagem.getText().getBytes("windows-1252"), cifradorRC4.intToBinary(this.getKey(), 16)), "windows-1252");
    ...
    public void descriptMessage(String msg) {
        ...
        if (((String) combEncriptador.getSelectedItem()).compareTo("SDES") == 0) {
            ...
            RC4 cifradorRC4 = new RC4();
            try {    
                plainText = new String(cifradorRC4.cifrar(msg.getBytes("windows-1252"), cifradorRC4.intToBinary(this.getKey(), 16)), "windows-1252");
            } catch (UnsupportedEncodingException ex) {
                Logger.getLogger(Tela.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else { //Eh AES
