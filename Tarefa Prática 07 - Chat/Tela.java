...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combEncriptador.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SDES", "RC4" }));
    ...
    public void descriptMessage(String msg) {
        ...
        if (((String) combEncriptador.getSelectedItem()).compareTo("SDES") == 0) {
            switch ((String) combModoCifra.getSelectedItem()) {
                case "CBC":
                    ...
                    plainText = cifradorCBC.decifraMensagem(msg, Integer.parseInt(txtChave.getText()), new SDES(), iv);
                    break;
                case "CTR":
                    Counter cifradorCTR = new Counter();
                     {
                        try {
                            plainText = cifradorCTR.decifrarMensagem(msg, Integer.parseInt(txtChave.getText()), new SDES());
                ...
                case "ECB":
                    ECB cifradorECB = new ECB();
                     {
                        try {
                            plainText = cifradorECB.decifrarMensagem(msg, Integer.parseInt(txtChave.getText()), new SDES());
                        } catch (IOException ex) {
                            Logger.getLogger(Tela.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
            ...
            if (((String) combEncriptador.getSelectedItem()).compareTo("SDES") == 0) {
                switch ((String) combModoCifra.getSelectedItem()) {
                    case "CBC":
                        CBC cifradorCBC = new CBC();
                        Integer iv[] = {1, 0, 0, 0, 1, 1, 0, 1};
                        cipherText = cifradorCBC.cifraMensagem(txtMensagem.getText(), Integer.parseInt(txtChave.getText()), new SDES(), iv);
                        break;
                    case "CTR":
                        Counter cifradorCTR = new Counter();
                         {
                            try {
                                cipherText = cifradorCTR.cifraMensagem(txtMensagem.getText(), Integer.parseInt(txtChave.getText()), new SDES());
                            } catch (IOException ex) {
                                Logger.getLogger(Tela.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
                    ...
                    case "ECB":
                        ECB cifradorECB = new ECB();
                         {
                            try {
                                cipherText = cifradorECB.cifrarMensagem(txtMensagem.getText(), Integer.parseInt(txtChave.getText()), new SDES());
                            } catch (IOException ex) {
                                Logger.getLogger(Tela.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
