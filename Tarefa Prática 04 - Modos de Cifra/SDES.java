...
public class SDES {
    ...
    public static int binaryToInt(Integer[] bin){
        int carac = 0;
    ...
    public static Integer[] createK1(Integer key){
        Integer[] k1;
    ...
    public static Integer[] createK2(Integer key){
    ...
    public static Integer decifrar(Integer c, Integer key){
    	Integer [] k1 = createK1(key);
    	Integer [] k2 = createK2(key);

    	Integer[] letra = intToBinary(c);
    	letra = IP(letra);
    	...
    	return binaryToInt(letra);
            
    }
    
    
    /*Funcao responsavel por crifar com o algoritmo SDES*/
    public static Integer cifrar(Integer c, Integer key){
    	Integer [] k1 = createK1(key);
    	Integer [] k2 = createK2(key);
